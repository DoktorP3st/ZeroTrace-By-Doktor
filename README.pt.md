...
- **Lista branca de sites** — proteja domínios; os seus cookies, localStorage e IndexedDB sobrevivem a cada limpeza
...
| **LocalStorage** | Preferências e dados dos sites *(lista branca protegida)* |
| **IndexedDB** | Bases de dados offline & PWA *(lista branca protegida)* |
...
Qualquer trabalho derivado deve permanecer open-source sob a mesma licença. O uso comercial sem publicar o código fonte não é permitido.

> O ZeroTrace nasceu sobretudo como um projeto pessoal: uma alternativa rápida e totalmente local às extensões de limpeza de navegador como o Click&Clean, pensada primeiro para o meu uso diário — sem servidores, sem recolha de dados, sem telemetria, e cada linha de código aberta para qualquer pessoa consultar. Partilhá-la publicamente pareceu-me natural: se também for útil a outras pessoas, é um bónus bem-vindo, não o objetivo. Sem intenção comercial.
